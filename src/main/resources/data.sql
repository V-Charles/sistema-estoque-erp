...
INSERT INTO usuarios (nome, login, senha, ativo, perfil)
VALUES ('Administrador', 'admin@gmail.com', '{noop}123456', true, 'ADMIN');

INSERT INTO usuarios (nome, login, senha, ativo, perfil)
VALUES ('João Estoquista', 'estoquista@system.com', '{noop}123456', true, 'ESTOQUISTA');
